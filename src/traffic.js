...
*/
TRAFFIC.TYPE_OF_CARS = [
    { w:1.8, l:12, h:1.4, m:'car001', name:'fordM'  , wPos:[0.76,0,1.46], wRadius:0.66, nWheels:4 ,speedf:1},
    { w:1.8, l:11, h:1.8, m:'car002', name:'vaz'    , wPos:[0.72,0,1.31], wRadius:0.36, nWheels:4,speedf:.98 },
    { w:2.2, l:12.5, h:1.5, m:'car003', name:'coupe'  , wPos:[0.96,0,1.49], wRadius:0.36, nWheels:4 ,speedf:.96},
    { w:2.2, l:12.8, h:1.9, m:'car004', name:'c4'     , wPos:[0.93,0,1.65], wRadius:0.40, nWheels:4 ,speedf:.94},
    { w:2.2, l:13, h:1.8, m:'car005', name:'ben'    , wPos:[0.88,0,1.58], wRadius:0.40, nWheels:4 ,speedf:.92},
    { w:2.1, l:13.3, h:1.7, m:'car006', name:'taxi'   , wPos:[0.90,0,1.49], wRadius:0.40, nWheels:4 ,speedf:.90},
    { w:2.2, l:13.4, h:1.9, m:'car007', name:'207'    , wPos:[0.94,0,1.60], wRadius:0.40, nWheels:4 ,speedf:.85},
    { w:2.3, l:14.7, h:1.7, m:'car008', name:'police' , wPos:[0.96,0,1.67], wRadius:0.40, nWheels:4 ,speedf:.8},
    { w:2.7, l:15.4, h:2.6, m:'car009', name:'van1'   , wPos:[1.14,0,1.95], wRadius:0.46, nWheels:4 ,speedf:.75},
    { w:2.2, l:16.5, h:2.8, m:'car010', name:'van2'   , wPos:[0.89,0,2.10], wRadius:0.40, nWheels:4 ,speedf:.7},
    { w:2.8, l:17.4, h:3.2, m:'car011', name:'van3'   , wPos:[0.90,0,1.83], wRadius:0.46, nWheels:4 ,speedf:.65},
    { w:2.8, l:22.1, h:3.9, m:'car012', name:'truck1' , wPos:[1.00,0,2.58], wRadius:0.57, nWheels:6 ,speedf:.64},
    { w:3.0, l:4+26.3, h:3.4, m:'car013', name:'truck1', wPos:[1.17,0,3.64], wRadius:0.57, nWheels:6 ,speedf:.63},
    { w:3.0, l:31.6, h:3.4, m:'car014', name:'bus'   , wPos:[1.25,0,2.49], wRadius:0.64, nWheels:4 ,speedf:.62},
 
    { w:1.8, l:12, h:1.4, m:'car001001', name:'fordM'  , wPos:[0.76,0,1.46], wRadius:0.66, nWheels:4 ,speedf:1},
    { w:1.8, l:11, h:1.8, m:'car002001', name:'vaz'    , wPos:[0.72,0,1.31], wRadius:0.36, nWheels:4,speedf:.98 },
    { w:2.2, l:12.5, h:1.5, m:'car003001', name:'coupe'  , wPos:[0.96,0,1.49], wRadius:0.36, nWheels:4 ,speedf:.96},
    { w:2.2, l:12.8, h:1.9, m:'car004001', name:'c4'     , wPos:[0.93,0,1.65], wRadius:0.40, nWheels:4 ,speedf:.94},
    { w:2.2, l:13, h:1.8, m:'car005001', name:'ben'    , wPos:[0.88,0,1.58], wRadius:0.40, nWheels:4 ,speedf:.92},
    { w:2.1, l:13.3, h:1.7, m:'car006001', name:'taxi'   , wPos:[0.90,0,1.49], wRadius:0.40, nWheels:4 ,speedf:.90},
    { w:2.2, l:13.4, h:1.9, m:'car007001', name:'207'    , wPos:[0.94,0,1.60], wRadius:0.40, nWheels:4 ,speedf:.85},
    { w:2.3, l:14.7, h:1.7, m:'car008001', name:'police' , wPos:[0.96,0,1.67], wRadius:0.40, nWheels:4 ,speedf:.8},
    { w:2.7, l:15.4, h:2.6, m:'car009001', name:'van1'   , wPos:[1.14,0,1.95], wRadius:0.46, nWheels:4 ,speedf:.75},
    { w:2.2, l:16.5, h:2.8, m:'car010001', name:'van2'   , wPos:[0.89,0,2.10], wRadius:0.40, nWheels:4 ,speedf:.7},
    { w:2.8, l:17.4, h:3.2, m:'car011001', name:'van3'   , wPos:[0.90,0,1.83], wRadius:0.46, nWheels:4 ,speedf:.65},
    { w:2.8, l:22.1, h:3.9, m:'car012001', name:'truck1' , wPos:[1.00,0,2.58], wRadius:0.57, nWheels:6 ,speedf:.64},
    { w:3.0, l:4+26.3, h:3.4, m:'car013001', name:'truck1', wPos:[1.17,0,3.64], wRadius:0.57, nWheels:6 ,speedf:.63},
    { w:3.0, l:31.6, h:3.4, m:'car014001', name:'bus'   , wPos:[1.25,0,2.49], wRadius:0.64, nWheels:4 ,speedf:.62},
